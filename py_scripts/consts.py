days_from_num_to_full_text = {0: "Понедельник", 1: "Вторник", 2: "Среда", 3: "Четверг", 4: "Пятница",
                              5: "Суббота"}
days_from_num_to_full_text_formatted = {0: "Понедельник", 1: "Вторник", 2: "Среду", 3: "Четверг",
                                        4: "Пятницу", 5: "Субботу"}
days_from_short_text_to_num = {'Пн': 0, 'Вт': 1, 'Ср': 2, 'Чт': 3, 'Пт': 4, 'Сб': 5}
days_from_short_text_to_full = {"Пн": "Понедельник", "Вт": "Вторник", "Ср": "Среда", "Чт": "Четверг",
                                "Пт": "Пятница", "Сб": "Суббота"}
days_from_full_text_to_num = {"Понедельник": 0, "Вторник": 1, "Среда": 2, "Четверг": 3, "Пятница": 4,
                              "Суббота": 5}
